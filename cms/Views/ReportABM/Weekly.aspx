...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportABM/WeeklyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportABM/WeeklyList") %>?month=" + month + "&year=" + year + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	...
	<li class="left active"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportABM")%></li>
    <li class="left"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportABM")%></li>
</ul>
