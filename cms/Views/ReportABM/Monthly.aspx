...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportABM/MonthlyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportABM/MonthlyList") %>?DateStart=" + dateS + "&DateEnd=" + dateE + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportABM") %></li>
	<li class="left"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportABM")%></li>
    <li class="left active"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportABM")%></li>
</ul>
