...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportABM/list") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportABM/list") %>?date=" + date + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left active"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportABM") %></li>
