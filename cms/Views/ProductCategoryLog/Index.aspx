...
var CategoryName = ($('#CategoryName').val()) ? $('#CategoryName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ProductCategoryLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&CategoryName="+CategoryName +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<ul class="tabNavigation">
    ...
    <li><%: @Html.ActionLink("Category Log", "Index", "ProductCategoryLog", new { @class = "selected" })%></li>
    <li><%: @Html.ActionLink("Variant Log", "Index", "ProductVariantLog")%></li>
</ul>
...
<tr>
    ...
    <td style="width:100px"><label>Category Name</label></td>
    <td style="width:150px">
        <input name="CategoryName" type="text" value="<%: ViewData["CategoryName"] %>" id="CategoryName" style="width:100px" />
    </td>
</tr>
<tr>
