...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportBM/list") %>?date=" + date + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left active"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportBM") %></li>
