...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportBM/WeeklyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportBM/WeeklyList") %>?month=" + month + "&year=" + year + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	...
	<li class="left active"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportBM")%></li>
    <li class="left"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportBM")%></li>
</ul>
