...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportBM/MonthlyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportBM/MonthlyList") %>?DateStart=" + dateS + "&DateEnd=" + dateE + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportBM") %></li>
	<li class="left"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportBM")%></li>
    <li class="left active"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportBM")%></li>
</ul>
