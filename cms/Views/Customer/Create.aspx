        ...
        <table width="100%" border="0" cellspacing="1" cellpadding="6">
          <tr>
            <td width="40%" valign="top">
                ...
                <div class="editor-field">
                    <%: Html.TextBoxFor(model => model.KtpId, new { @style = "width:200px" })%>
                ...
                <div class="editor-field">
                    <%: Html.TextBoxFor(model => model.BirthDate, new { @style = "width:90px" })%>
            ...
            <td valign="top">
                ...
                <div class="editor-field" style="border:1px solid #aaa;padding:10px;width:400px">
                ...
                <% if (CommonModel.UserRole() == "ABM" || CommonModel.UserRole() == "RBH")
                   { %>
                   <label>&nbsp;&nbsp;Branch &nbsp;</label>
                    <%= Html.DropDownList("BranchId", new SelectList((IEnumerable<Branch>)ViewData["Branchs"], "BranchCode", "Name"), new { @id = "BranchId" })%>
                <% } %>
                <br /><br />
                <label>&nbsp;&nbsp;Sales &nbsp;</label>
                <%= Html.DropDownList("SalesId", new SelectList((IEnumerable<Sale>)ViewData["Sales"], "SalesId", "Name"), new { @id = "SalesId" })%>
                <% } %>
                </div>
