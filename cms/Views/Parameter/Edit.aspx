<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<cms.Models.MaterParameter>" %>
...
<ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Parameter", "Index", "Parameter")%></li>
...
<% using (Html.BeginForm("Edit", "Parameter", FormMethod.Post, new { enctype = "multipart/form-data" }))
   { %>
    ...
    <fieldset>
        ...
        <div class="editor-field">
            <%: Html.TextBoxFor(model => model.ParameterName, new { @style = "width:100px" })%>
        ...
        <div class="editor-field">
            <%: Html.TextBoxFor(model => model.ParameterValue, new { @style = "width:100px" })%>
