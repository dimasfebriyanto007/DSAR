...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list(page) {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/Parameter/list") %>",
...
<%--<p class="create-link2" style="margin:5px 0 0 0;padding:0px">
    <a class="create" href="<%: Url.Content("~/Area/Create") %>">Add New Area</a>
</p>--%>

<div class="urut">
Order By
<select id="orderBy">    
    <option value="ParameterName">Parameter Name</option>
    <option value="ParameterValue">Parameter Value</option>
</select>
&nbsp;
<select id="orderMode">
