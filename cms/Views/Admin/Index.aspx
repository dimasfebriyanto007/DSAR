...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list(page) {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/Admin/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&key=" + key + "&orderBy=" + orderBy + "&orderMode=" + orderMode + "&Role=" + Role,
...
<select id="Role">
    ...
    <option value="ADMINBUSSINES">Admin Bussines</option>
</select>
...
<p class="create-link2" style="margin:5px 0 0 0;padding:0px">
    <a class="create" href="<%: Url.Content("~/Admin/Create") %>">Add New Admin</a>
</p>
