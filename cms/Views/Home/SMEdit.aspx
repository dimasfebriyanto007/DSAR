...
<p style="text-align: right;">
         	<a href="http://10.221.5.24/index.php" style="text-decoration: none" target="_blank"><span style="color:#ffa500;"><span style="font-family:verdana,geneva,sans-serif;"><span style="font-size:12px;">Tiger Community Portal |</a>
			<a href="http://dcapplpks01/default.aspx" style="text-decoration: none" target="_blank"> <span style="color:#b22222;"><span style="font-family:verdana,geneva,sans-serif;"><span style="font-size:12px;">Product Knowledges |</a>
			<a href="http://10.221.5.23/sp/" style="text-decoration: none" target="_blank"><span style="color:#000000;"><span style="font-family:verdana,geneva,sans-serif;"><span style="font-size:12px;">TigerNest Sales |</a>
			<a href="http://10.221.5.23/kpi/index.php" style="text-decoration: none" target="_blank"><span style="color:#ffa500;"><span style="font-family:verdana,geneva,sans-serif;"><span style="font-size:12px;">TigerNet Service </a>
		</span>
...
<% using (Html.BeginForm("SMEdit", "Home", FormMethod.Post, new { enctype = "multipart/form-data" }))
   { %>
    <%: Html.ValidationSummary(true) %>
    <fieldset>
                
        <%
       if (ViewBag.notAbsen.ToString() == "1" && CommonModel.UserRole() == "SM")
       {
             %>
