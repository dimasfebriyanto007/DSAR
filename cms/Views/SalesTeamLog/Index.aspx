...
var STName = ($('#STName').val()) ? $('#STName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/SalesTeamLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&STName="+STName +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Sales Team", "Index", "SalesTeamLog")%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Descrption</label></td>
    <td style="width:150px">
        <input name="STName" type="text" value="<%: ViewData["STName"] %>" id="STName" style="width:100px" />
    </td>
</tr>
<tr>
