...
var GCIF = ($('#GCIF').val()) ? $('#GCIF').val() : '';
var CustomerName = ($('#CustomerName').val()) ? $('#CustomerName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/CustomerLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&CustomerName="+CustomerName +"&GCIF="+GCIF +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Customer", "Index", "CustomerLog")%></li>
...
<tr>
    ...
    <td style="width:130px"><label>GCIF</label></td>
    <td style="width:150px">
        <input name="GCIF" type="text" value="<%: ViewData["GCIF"] %>" id="GCIF" style="width:100px" />
    </td>
</tr>
<tr>
    ...
    <td>
        <input name="CustomerName" type="text" value="<%: ViewData["CustomerName"] %>" id="CustomerName" style="width:100px" />
    </td>
</tr>
<tr>
