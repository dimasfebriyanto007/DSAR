...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <ul id="tab">
        ...
        <li class="left active">
            <%: @Html.ActionLink("Product", "Index", "Product") %></li>
        <li class="left">
            <%: @Html.ActionLink("Region", "Index", "Region")%></li>
        <li class="left">
            <%: @Html.ActionLink("Area", "Index", "Area")%></li>
        <li class="left">
            <%: @Html.ActionLink("Branch", "Index", "Branch")%></li>
        <li class="left">
            <%: @Html.ActionLink("Call Reason", "Index", "CallReason")%></li>
        <li class="left">
            <%: @Html.ActionLink("Visit Reason", "Index", "VisitReason")%></li>
        <li class="left">
            <%: @Html.ActionLink("Sales Team", "Index", "SalesTeam")%></li>
        <%
        } 
        %>
        <%
        ...
        %>
        <li class="left">
            <%: @Html.ActionLink("Parameter", "Index", "Parameter")%></li>
        <%
        } 
        %>
    </ul>
    <ul class="tabNavigation">
        <li>
            <%: @Html.ActionLink("Product", "Index", "Product", new { @class = "selected" })%></li>
        <li>
            <%: @Html.ActionLink("Category", "Index", "ProductCategory")%></li>
        <li>
            <%: @Html.ActionLink("Variant", "Index", "ProductVariant")%></li>
    </ul>
    <h1>
        Edit Product</h1>
    ...
    <fieldset>
        ...
        <div class="editor-label">
            <label>
                Image Popup (JPG)</label>
        </div>
        <div class="editor-field">
            <%
           System.IO.FileInfo File2 = new System.IO.FileInfo(Server.MapPath("~") + "\\images\\product\\" + Model.ImageName + ".jpg");
           if (File2.Exists)
           {
            %>
            <img src="<%: Url.Content("~/images/product/" + Model.ImageName + ".jpg") %>" border="0" /><br />
            <%
       }
            %>
