...
var RegionName = ($('#RegionName').val()) ? $('#RegionName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/RegionLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&RegionName="+RegionName +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
	...
	<li class="left active"><%: @Html.ActionLink("Region", "Index", "RegionLog")%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Region Name</label></td>
    <td style="width:150px">
        <input name="RegionName" type="text" value="<%: ViewData["RegionName"] %>" id="RegionName" style="width:100px" />
    </td>
</tr>
<tr>
