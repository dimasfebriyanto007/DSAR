...
var Description = ($('#Description').val()) ? $('#Description').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/VisitReasonLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&Description="+Description +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Visit Reason", "Index", "VisitReasonLog")%></li>
...
<tr>
    ...
    <td style="width:150px">
        <input name="Descrption" type="text" value="<%: ViewData["Descrption"] %>" id="Descrption" style="width:100px" />
    </td>
</tr>
<tr>
