...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportRBH/MonthlyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportRBH/MonthlyList") %>?DateStart=" + dateS + "&DateEnd=" + dateE + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportRBH")%></li>
</ul>
