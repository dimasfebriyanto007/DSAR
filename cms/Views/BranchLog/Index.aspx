...
var BranchName = ($('#BranchName').val()) ? $('#BranchName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/BranchLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&BranchName="+BranchName +"&Name="+Name +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Branch", "Index", "BranchLog")%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Branch Name</label></td>
    <td style="width:150px">
        <input name="BranchName" type="text" value="<%: ViewData["BranchName"] %>" id="BranchName" style="width:100px" />
    </td>
</tr>
<tr>
