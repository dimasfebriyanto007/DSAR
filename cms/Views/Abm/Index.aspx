...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list(page) {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/Abm/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&key=" + key + "&orderBy=" + orderBy + "&orderMode=" + orderMode + "&Area=" + Area,
...
<ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("ABM", "Index", "Abm")%></li>
    <li class="left"><%: @Html.ActionLink("RBH", "Index", "Rbh")%></li>
    <li class="left"><%: @Html.ActionLink("Admin", "Index", "Admin")%></li>
</ul>

<h1>Area Branch Manager</h1>

<div class="form"><label>Search&nbsp;&nbsp; </label>
<input name="searchWord" type="text" value="" id="key" />

<label>&nbsp;&nbsp;Area &nbsp;</label>
<%= Html.DropDownList("Area", new SelectList((IEnumerable<Area>) ViewData["Areas"], "AreaCode", "Name"), "-- All --", new { @id = "Area" })%>
...
<p class="create-link2" style="margin:5px 0 0 0;padding:0px">
    <a class="create" href="<%: Url.Content("~/Abm/Create") %>">Add New ABM</a>
</p>
