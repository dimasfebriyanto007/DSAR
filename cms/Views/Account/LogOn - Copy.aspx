    ...
    <% using (Html.BeginForm("LogOn", "Account", FormMethod.Post, new { @class = "login-form", @style = "color:#fff" }))
       { %>
        <%: Html.ValidationSummary(true, "Login was unsuccessful. Please correct the errors and try again.") %>
			...
			<br>
			<span style="color:#ffa500;"><span style="font-family:verdana,geneva,sans-serif;"><span style="font-size:14px;">
			<a href="http://10.221.5.24/index.php" target="_blank">Tiger Community Portal |</a>
			<a href="http://dcapplpks01/default.aspx" target="_blank">Product Knowledges |</a>
			<a href="http://10.221.5.23/sp/" target="_blank">TigerNest Sales |</a>
			<a href="http://10.221.5.23/kpi/index.php" target="_blank">TigerNet Service </a>
			</span></span></span>
			</p>
        </div>
    <% } %>
