...
var UserName = ($('#UserName').val()) ? $('#UserName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/BranchManagerLog/list") %>",
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left"><%: @Html.ActionLink("Informasi", "Index", "InformasiLog")%></li>
...
<ul class="tabNavigation">
    <li><%: @Html.ActionLink("Sales ", "Index", "SalesLog")%></li>
    <li><%: @Html.ActionLink("Sales Leader ", "Index", "SalesManagerLog")%></li>
    <li><%: @Html.ActionLink("Branch Manager ", "Index", "BranchManagerLog", new { @class = "selected" })%></li>
