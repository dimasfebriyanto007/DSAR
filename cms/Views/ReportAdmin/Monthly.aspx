...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportAdmin/MonthlyList") %>",
		        data: "DateStart=" + dateS + "&DateEnd=" + dateE + "&branch=" + Branch + "&team=" + Team,
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportAdmin/MonthlyList") %>?DateStart=" + dateS + "&DateEnd=" + dateE + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportAdmin") %></li>
	<li class="left"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportAdmin")%></li>
    <li class="left active"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportAdmin")%></li>
</ul>
