...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportAdmin/list") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportAdmin/list") %>?date=" + date + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	<li class="left active"><%: @Html.ActionLink("Daily Sales Report", "Index", "ReportAdmin") %></li>
