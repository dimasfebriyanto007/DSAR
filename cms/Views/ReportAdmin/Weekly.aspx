...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportAdmin/WeeklyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportAdmin/WeeklyList") %>?month=" + month + "&year=" + year + "&branch=" + Branch + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	...
	<li class="left active"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportAdmin")%></li>
    <li class="left"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportAdmin")%></li>
</ul>
