...
var VariantName = ($('#VariantName').val()) ? $('#VariantName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ProductVariantLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&VariantName="+VariantName +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
	<li class="left active"><%: @Html.ActionLink("Product", "Index", "ProductLog")%></li>
    ...
    <li class="left"><%: @Html.ActionLink("User", "Index", "SalesLog")%></li>
    
</ul></div>


<ul class="tabNavigation">
    <li><%: @Html.ActionLink("Product Log", "Index", "ProductLog")%></li>
    <li><%: @Html.ActionLink("Category Log", "Index", "ProductCategoryLog")%></li>
    <li><%: @Html.ActionLink("Variant Log", "Index", "ProductVariantLog", new { @class = "selected" })%></li>
</ul>
...
<tr>
    ...
    <td style="width:100px"><label>variant Name</label></td>
    <td style="width:150px">
        <input name="VariantName" type="text" value="<%: ViewData["VariantName"] %>" id="VariantName" style="width:100px" />
    </td>
</tr>
<tr>
