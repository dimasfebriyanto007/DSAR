...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list(page) {
            ...
            var selectedSales = ($('#Sales').val()) ? $('#Sales').val() : '';
		    ...
		    ({
		        ...
		        data: "page=" + page + "&perpage=" + perpage + "&key=" + key + "&orderBy=" + orderBy + "&orderMode=" + orderMode + "&Status=" + Status + "&selectedSales=" + selectedSales,
