...
var Title = ($('#Title').val()) ? $('#Title').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/NewsLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&Title="+Title +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Informasi", "Index", "NewsLog")%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Title</label></td>
    <td style="width:150px">
        <input name="Title" type="text" value="<%: ViewData["Title"] %>" id="Title" style="width:100px" />
    </td>
</tr>
<tr>
