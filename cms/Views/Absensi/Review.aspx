    ...
    $(document).ready(function () {
        ...
        function load_list() {
            ...
            if (Sales==''){
                $.blockUI({
                    overlayCSS: { backgroundColor: '#000',opacity: .95 },
                    message: "<p>Silahkan pilih sales terlebih dahulu untuk melihat data absensi-nya</p>",
                    timeout: 3000,
                    theme: true
                });
                return false;
...
<label>&nbsp;&nbsp;<input class="button" value=" Lihat Absensi " type="button" id="load" /></label>
</div>
