<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<cms.Models.Region>" %>
...
<% using (Html.BeginForm("Create", "Region", FormMethod.Post, new { enctype = "multipart/form-data" }))
   { %>
