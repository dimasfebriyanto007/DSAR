...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list(page) {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ProductLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&ProductName="+ProductName +"&Name="+Name +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<ul class="tabNavigation">
    <li><%: @Html.ActionLink("Product Log", "Index", "ProductLog", new { @class = "selected" })%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Product Name</label></td>
    <td style="width:150px">
        <input name="ProductName" type="text" value="<%: ViewData["ProductName"] %>" id="ProductName" style="width:100px" />
    </td>
</tr>
<tr>
