...
var AreaName = ($('#AreaName').val()) ? $('#AreaName').val() : '';
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/AreaLog/list") %>",
		        data: "page=" + page + "&perpage=" + perpage + "&DateTo=" + DateTo +"&DateEnd="+DateEnd+"&Action="+Action+"&Npk="+Npk+"&Name="+Name +"&AreaName="+AreaName +"&orderBy=" + orderBy + "&orderMode=" + orderMode,
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
 ...
 <div><ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Area", "Index", "AreaLog")%></li>
...
<tr>
    ...
    <td style="width:100px"><label>Area Name</label></td>
    <td style="width:150px">
        <input name="AreaName" type="text" value="<%: ViewData["AreaName"] %>" id="AreaName" style="width:100px" />
    </td>
</tr>
<tr>
