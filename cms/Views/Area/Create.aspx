<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<cms.Models.Area>" %>
...
<ul id="tab">
    ...
    <li class="left active"><%: @Html.ActionLink("Area", "Index", "Area")%></li>
...
<% using (Html.BeginForm("Create", "Area", FormMethod.Post, new { enctype = "multipart/form-data" }))
   { %>
    ...
    <fieldset>
        ...
        <div class="editor-field">
            <%: Html.TextBoxFor(model => model.AreaCode, new { @style = "width:100px" })%>
