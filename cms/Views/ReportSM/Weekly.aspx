...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        function load_list() {
		    ...
		    ({
		        type: "POST",
		        url: "<%: Url.Content("~/ReportSM/WeeklyList") %>",
        ...
        $('#export').click(function(){
            ...
            document.location = "<%: Url.Content("~/ReportSM/WeeklyList") %>?month=" + month + "&year=" + year + "&team=" + Team + "&export=1";
        });
...
<ul id="tab">
	...
	<li class="left active"><%: @Html.ActionLink("Weekly Sales Report", "Weekly", "ReportSM")%></li>
    <li class="left"><%: @Html.ActionLink("Monthly Sales Report", "Monthly", "ReportSM")%></li>
</ul>
