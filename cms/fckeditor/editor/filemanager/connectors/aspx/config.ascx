...
<script runat="server">
	...
	public override void SetConfig()
	{
		...
		// UserFilesPath = "/fitbar/uploads/";
		UserFilesPath = "dsar/uploads/";
		...
		TypeConfig[ "File" ].AllowedExtensions			= new string[] { "pdf","7z", "aiff", "asf", "avi", "bmp", "csv", "doc", "fla", "flv", "gif", "gz", "gzip", "jpeg", "jpg", "mid", "mov", "mp3", "mp4", "mpc", "mpeg", "mpg", "ods", "odt", "pdf", "png", "ppt", "pxd", "qt", "ram", "rar", "rm", "rmi", "rmvb", "rtf", "sdc", "sitd", "swf", "sxc", "sxw", "tar", "tgz", "tif", "tiff", "txt", "vsd", "wav", "wma", "wmv", "xls", "xml", "zip" };
