(function ($) {
    ...
    $.datepicker._updateDatepicker = function (inst) {
        ...
        var bottomLayer = $(".ui-datepicker-buttonpane").prepend(html3);
        bottomLayer.prepend(" : ");
        bottomLayer.prepend(html2);
        bottomLayer.prepend(" : ");
        bottomLayer.prepend(html1);
        bottomLayer.prepend("Pukul ");                                
        bottomLayer.prepend("<div style='clear:both'></div><div class='.datetimepicker' />");
    ...
    function DateTimePicker(options) {
        ...
        for (i = 1; i <= 23; i++) html1 = hourHTML.append("<option>" + i + "</option");
        for (i = 0; i < 60; i = i + 5) {
            var strMin = (i.toString().length == 1) ? "0" + i : i;
            html2 = minutsHTML.append("<option>" + strMin + "</option");
        }
        for (i = 0; i < 60; i = i + 5) {
            var strSec = (i.toString().length == 1) ? "0" + i : i;
            html3 = secondHTML.append("<option>" + strSec + "</option");
        }
    }
