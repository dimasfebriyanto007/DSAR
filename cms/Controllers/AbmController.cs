...
{
    [Authorize]
    public class AbmController : CommonController
    {
        ...
        public ActionResult list(int page = 1, string key = "", int perpage = 20, string orderBy = "", string orderMode = "", string Area = "")
        {
            if (!((CommonModel.UserRole() == "ADMIN") || (CommonModel.UserRole() == "ADMINUSER"))) return RedirectToAction("Index", "Home");
            ...
            var data = (from c in _db.Users
                        where c.Role == "ABM"
                        join d in _db.ABMs on c.RelatedId equals d.AbmId
                        join e in _db.Areas on d.AreaCode equals e.AreaCode into join1
            ...
            if (Area != "")
            {
                data = data.Where(c => c.AreaCode == Area);
            }
            ...
            switch (orderBy)
            {
                ...
                case "area": if (orderMode == "asc") data = data.OrderBy(c => c.AreaName); else data = data.OrderByDescending(c => c.AreaName); break;
            ...
            msg += "<table class=\"grid-style\" width=\"100%\"><thead><tr><th>No</th><th>NPK</th><th>Name</th><th>Email</th><th>Phone</th><th>Area</th><th>Last Login</th><th>Option</th>";
            ...
            foreach (var item in result)
            {
                ...
                msg += "<tr class=\"" + klas + "\">" +
                       ...
                       "<td align=\"center\"><a href=\"" + Url.Content("~/Abm/Edit/" + item.AbmId) + "\" title=\"Edit\"><img src=\"" + Url.Content("~/Content/images/icon-edit.gif") + "\" border=\"0\"/></a> <a href=\"" + Url.Content("~/Abm/Delete/" + item.AbmId) + "\" title=\"Delete\"><img src=\"" + Url.Content("~/Content/images/icon-delete.gif") + "\" border=\"0\"/></a></td>" +
                       "</tr>";
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Create([Bind(Exclude = "AbmId")] ABM dataToCreate)
        {
            if (!((CommonModel.UserRole() == "ADMIN") || (CommonModel.UserRole() == "ADMINUSER"))) return RedirectToAction("Index", "Home");
            ...
            try
            {
                ...
                var checkNpk = _db.ABMs.Where(c => c.Npk == dataToCreate.Npk);
                ...
                user.Role = "ABM";
                user.RelatedId = dataToCreate.AbmId;
                ...
                string messageError = LogsModel.SaveLogABM(new ABM(), dataToCreate, new UserLogModel(), dataUserNew, "Add");
        ...
        public ActionResult Edit(int id)
        {
            ...
            var dataToEdit = (from m in _db.ABMs
                              where m.AbmId == id
                              select m).First();
            User user = _db.Users.Where(c => c.RelatedId == dataToEdit.AbmId && c.Role == "ABM").First();
        ...
        [HttpPost]
        [ValidateInput(false)]
        public ActionResult Edit(ABM dataToEdit)
        {
            if (!((CommonModel.UserRole() == "ADMIN") || (CommonModel.UserRole() == "ADMINUSER"))) return RedirectToAction("Index", "Home");
            ...
            try
            {
                ...
                var originalData = (from m in _db.ABMs
                                    where m.AbmId == dataToEdit.AbmId
                                    select m).First();

                var originalUser = (from m in _db.Users
                                    where m.RelatedId == dataToEdit.AbmId && m.Role == "ABM"
                                    select m).First();
                ...
                var checkNpk = _db.ABMs.Where(c => c.Npk == dataToEdit.Npk && c.AbmId != originalData.AbmId);
                ...
                dataNew = dataToEdit;
                string messageError = LogsModel.SaveLogABM(dataOld, dataNew, dataUserOld, dataUserNew, "Edit");
                if (!string.IsNullOrEmpty(messageError))
                {
                    ViewData["Output"] = messageError;
                    return View();
        ...
        public ActionResult Delete(int id)
        {
            ...
            var dataToDelete = (from m in _db.ABMs
                                where m.AbmId == id
                                select m).First();
        ...
        [HttpPost]
        public ActionResult Delete(int id, ABM dataToDelete)
        {
            if (!((CommonModel.UserRole() == "ADMIN") || (CommonModel.UserRole() == "ADMINUSER"))) return RedirectToAction("Index", "Home");
            ...
            var originalUser = (from m in _db.Users
                                where m.RelatedId == originalData.AbmId && m.Role == "ABM"
                                select m).First();
            try
            {
                ...
                string messageError = LogsModel.SaveLogABM(originalData, new ABM(), originalUsers, new UserLogModel(), "Delete");
                if (!string.IsNullOrEmpty(messageError))
                {
                    ViewData["Output"] = messageError;
                    return View(originalData);
