...
{
    [Authorize]
    public class SalesSMController : CommonController
    {

        public ActionResult Index()
        {
            if (CommonModel.UserRole() != "SM") return RedirectToAction("Index", "Home");
        ...
        public ActionResult list(int page = 1, string key = "", int perpage = 20, string orderBy = "", string orderMode = "", string Team = "", string Branch = "")
        {
            ...
            SalesManager sm = _db.SalesManagers.Where(c => c.ManagerId == user.RelatedId).First();
            ...
            foreach (var item in result)
            {
                ...
                msg += "<tr class=\"" + klas + "\">" +
                       ...
                       "<td align=\"center\"><a href=\"" + Url.Content("~/SalesSM/Edit/" + item.SalesId) + "\" title=\"Edit\"><img src=\"" + Url.Content("~/Content/images/icon-edit.gif") + "\" border=\"0\"/></a></td>" +
                       "</tr>";
        ...
        public ActionResult Create()
        {
            ...
            ViewData["Teams"] = _db.SalesTeams.OrderBy(c => c.Name).ToList();
            ViewData["Branchs"] = _db.Branchs.Where(c => c.BranchCode == sm.BranchCode).OrderBy(c => c.Name).ToList(); // Where -> added by Aditia 20160831
        ...
        public ActionResult Create([Bind(Exclude = "SalesId")] Sale dataToCreate)
        {
            ...
            try
            {
                ...
                dataToCreate.SmId = sm.ManagerId;
                ...
                if (String.IsNullOrWhiteSpace(Npk)) { ViewData["Output"] = "Invalid NPK"; return View(dataToCreate); }
                if (String.IsNullOrWhiteSpace(Name)) { ViewData["Output"] = "Invalid Name"; return View(dataToCreate); }
        ...
        public ActionResult Edit(Sale dataToEdit)
        {
            ...
            try
            {
                ...
                dataToEdit.SmId = originalData.SmId;
